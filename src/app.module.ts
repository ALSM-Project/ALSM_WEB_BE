...
import { ConversionJob, ConversionJobSchema } from './modules/conversions/infrastructure/conversion-job.schema';
...
import { CONVERSION_ENGINE, CONVERSION_JOB_REPOSITORY, CONVERSION_QUEUE } from './modules/conversions/domain/conversion-job.types';
