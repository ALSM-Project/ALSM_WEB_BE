...
## Purpose
Conversion job/result orchestration and external tool boundary.

## Owns
- conversion jobs, queue orchestration, tool strategy, execution state

## Does Not Own
- actual parser/mapping/generator algorithms
